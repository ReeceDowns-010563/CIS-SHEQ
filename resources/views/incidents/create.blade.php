            ...
            <form action="{{ route('incidents.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="brief_description" name="brief_description" class="mt-1 block w-full"
                                      value="{{ old('brief_description') }}" required placeholder="e.g., Slip on wet floor in reception area." />
                    ...
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="incident_type_id" name="incident_type_id" required
                                ...
                                @endforeach
                                <option value="other" {{ old('incident_type_id') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                    ...
                    <div id="incident_type_other_container" style="{{ old('incident_type_id') === 'other' ? '' : 'display: none;' }}">
                        ...
                        <x-text-input id="incident_type_other_description" name="incident_type_other_description" class="mt-1 block w-full"
                                      value="{{ old('incident_type_other_description') }}" placeholder="Please specify the type of accident" />
                        @error('incident_type_other_description')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="additional_information" name="additional_information" rows="3"
                                  class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('additional_information') }}</textarea>
                ...
                <div class="space-y-4 pt-6">
                    ...
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="affected_person_type" name="affected_person_source" required
                                ...
                                <option value="Employee" {{ old('affected_person_source') === 'Employee' ? 'selected' : '' }}>Employee</option>
                                <option value="Other" {{ old('affected_person_source') === 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                            <div class="search-overlay">
                            ...
                            <select id="affected_employee_id" name="affected_employee_id"
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                            data-site-id="{{ $employee->site_id }}"
                                            data-site-name="{{ $employee->site->name ?? '' }}"
                                            data-branch-code="{{ $employee->site->branch_code ?? '' }}"
                                        {{ old('affected_employee_id') == $employee->id ? 'selected' : '' }}>
                    ...
                    <div id="affected_person_other_container" class="person-detail-container">
                        ...
                        <x-text-input id="affected_person_name" name="affected_person_other"
                                      class="mt-1 block w-full person-name-input"
                                      value="{{ old('affected_person_other') }}"
                                      placeholder="Enter full name of affected person" />
                        @error('affected_person_other')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="space-y-4 pt-6">
                    ...
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="reported_by_type" name="reported_by_source" required
                                    class="custom-select mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Select type...</option>
                                <option value="Employee" {{ old('reported_by_type', 'Employee') === 'Employee' ? 'selected' : '' }}>Employee</option>
                                <option value="Other" {{ old('reported_by_type') === 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                            <div class="search-overlay">
                                <input type="text" class="search-input" placeholder="Type to search...">
                                <div class="search-results"></div>
                            ...
                            <select id="reported_employee_id" name="reported_employee_id"
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                            ...
                                            data-site-name="{{ $employee->site->name ?? '' }}"
                                            data-branch-code="{{ $employee->site->branch_code ?? '' }}"
                                        {{ old('reported_employee_id') == $employee->id ? 'selected' : '' }}>
                                        {{ $employee->first_name }} {{ $employee->last_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div id="reported_by_other_container" class="person-detail-container">
                        ...
                        <x-text-input id="reported_by_name" name="reported_by_other"
                                      class="mt-1 block w-full person-name-input"
                                      value="{{ old('reported_by_other') }}"
                                      placeholder="Enter full name of person reporting this incident" />
                        @error('reported_by_other')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="physician_details" name="physician_details" rows="3"
                                  ...
                                  class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('physician_details') }}</textarea>
                        @error('physician_details')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="date_of_occurrence" type="date" name="date_of_occurrence"
                                          value="{{ old('date_of_occurrence') }}" required class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <x-text-input id="time_of_occurrence" type="time" name="time_of_occurrence"
                                          value="{{ old('time_of_occurrence') }}" required class="mt-1 block w-full" />
                            @error('time_of_occurrence')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="branch_id" name="branch_id" required
                                ...
                                @foreach($branches as $branch)
                                    <option value="{{ $branch->id }}" data-branch-code="{{ $branch->branch_code }}" {{ old('branch_id') == $branch->id ? 'selected' : '' }}>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="site_id" name="site_id"
                                ...
                                @foreach($sites as $site)
                                    <option value="{{ $site->id }}" data-branch-code="{{ $site->branch_code }}" {{ old('site_id') == $site->id ? 'selected' : '' }}>
                                        {{ $site->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="space-y-4 pt-6">
                                ...
                                <div class="body-parts-dropdown" id="body-parts-dropdown">
                                    ...
                                    <div class="body-parts-options" id="body-parts-options">
                                        ...
                                        @foreach($bodyParts as $bodyPart)
                                            <div class="body-part-option" data-body-part-id="{{ $bodyPart->id }}" data-body-part-name="{{ $bodyPart->name }}">
                                                <div class="body-part-option-checkbox">
                                                    <input type="checkbox" name="body_part_id[]" id="body-part-{{ $bodyPart->id }}" value="{{ $bodyPart->id }}"
                                                        {{ in_array($bodyPart->id, $selectedBodyParts) ? 'checked' : '' }}>
                                                </div>
                                                <div class="body-part-option-details">
                                                    <div class="body-part-option-name">{{ $bodyPart->name }}</div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class="body-part-option" data-body-part-id="other" data-body-part-name="Other">
                                            <div class="body-part-option-checkbox">
                                                <input type="checkbox" name="body_part_id[]" id="body-part-other" value="other"
                                                       {{ in_array('other', $selectedBodyParts) ? 'checked' : '' }}
                    ...
                    <div id="body_part_other_container" style="{{ in_array('other', $selectedBodyParts) ? '' : 'display: none;' }}">
                        <label for="body_part_other" class="block font-medium text-sm text-gray-800 dark:text-gray-200 mb-1">
                            Specify Other Body Part
                        </label>
                        <x-text-input id="body_part_other" name="body_part_other" class="mt-1 block w-full"
                                      value="{{ old('body_part_other') }}" placeholder="Please specify the affected body part" />
                        @error('body_part_other')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <select id="injury_type_id" name="injury_type_id"
                                ...
                                @foreach($injuryTypes as $injuryType)
                                    <option value="{{ $injuryType->id }}" {{ old('injury_type_id') == $injuryType->id ? 'selected' : '' }}>
                                        {{ $injuryType->name }}
                                    </option>
                                @endforeach
                                <option value="other" {{ old('injury_type_id') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            <div class="search-overlay">
                        ...
                        @error('injury_type_id')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>

                    <div id="injury_type_other_container" style="{{ old('injury_type_id') === 'other' ? '' : 'display: none;' }}">
                        ...
                        <x-text-input id="injury_type_other" name="injury_type_other" class="mt-1 block w-full"
                                      value="{{ old('injury_type_other') }}" placeholder="Please specify the nature of injury/illness" />
                        @error('injury_type_other')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="what_happened" name="what_happened" rows="4" required
                                  ...
                                  class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('what_happened') }}</textarea>
                        @error('what_happened')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="space-y-4 pt-6">
                    ...
                    <div>
                        ...
                        <div class="bcc-email-container">
                                ...
                                <div class="bcc-dropdown" id="bcc-dropdown">
                                    ...
                                    <div class="bcc-options" id="bcc-options">
                                        @foreach($allUsers as $user)
                                            <div class="bcc-option" data-user-id="{{ $user->id }}" data-user-name="{{ $user->name }}" data-user-email="{{ $user->email }}">
                                                <div class="bcc-option-checkbox">
                                                    <input type="checkbox" id="bcc-user-{{ $user->id }}" value="{{ $user->id }}">
                                                </div>
                                                <div class="bcc-option-details">
                                                    <div class="bcc-option-name">{{ $user->name }}</div>
                                                    <div class="bcc-option-email">{{ $user->email }}</div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <input type="hidden" name="bcc_emails" id="bcc-emails-input" value="{{ old('bcc_emails') }}">
                        </div>
                        @error('bcc_emails')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
