        ...
        <div class="header-container">
            <div class="header-left">
                ...
                <div>
                    ...
                    <p class="site-id">Site ID: {{ $site->id }}</p>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="main-container">
        <div class="content-wrapper">
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('settings.sites.update', $site) }}">
                    @csrf
                    @method('PUT')
                                    ...
                                    <div class="custom-dropdown">
                                        <div class="dropdown-toggle @error('branch_id') error @enderror" id="branchDropdown">
                                            <span class="dropdown-text">
                                                @if(old('branch_id', $site->branch_id))
                                                    @php
                                        ...
                                        <input type="hidden" name="branch_id" id="branchIdInput" value="{{ old('branch_id', $site->branch_id) }}">
                                    </div>
                                    @error('branch_id')
                                    <span class="form-error">{{ $message }}</span>
                                    @enderror
