    ...
    <div class="main-container">
        <div class="content-wrapper">
            ...
            <div class="search-filters-container">
                <form method="GET" action="{{ route('settings.emails.templates.index') }}" class="search-form">
                    <!-- Search -->
                    ...
                    @if($search || $category)
                        <div class="search-group">
                            <a href="{{ route('settings.emails.templates.index') }}" class="clear-filters-btn">
                                Clear Filters
                            </a>
                        </div>
                    @endif
                        ...
                        <div class="template-card">
                                ...
                                <div>
                                    ...
                                    <div class="template-meta">
                                        ...
                                        @if($template->category)
                                            <strong>Category:</strong> {{ ucfirst($template->category) }}
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="template-actions">
                                <span class="variable-count">
                                    ...
                                    @endphp
                                    {{ $variableCount }} {{ Str::plural('variable', $variableCount) }}
                                </span>

                                <div class="action-buttons">
                                    <a href="{{ route('settings.emails.templates.show', $template) }}" class="btn btn-primary">
                                    ...
                                    @can('sendTest', $template)
                                        <button class="btn btn-success" onclick="openTestModal({{ $template->id }}, '{{ e($template->name) }}')">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
