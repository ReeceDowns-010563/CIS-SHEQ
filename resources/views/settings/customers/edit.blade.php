<x-app-layout>
    <x-slot name="header">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Edit Customer</h2>
    </x-slot>
    ...
    <div class="py-10 px-4">
        <div class="max-w-3xl mx-auto mt-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <form method="POST" action="{{ route('settings.customers.update', $customer) }}" class="space-y-6">
                @csrf
                @method('PUT')
