    ...
    <div class="settings-container">
        <div class="content-wrapper">
            ...
            <div class="settings-grid">
                ...
                <a href="{{ route('settings.users.index') }}" class="setting-card">
                    <div class="card-icon">
                ...
                <a href="{{ route('settings.customers.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('settings.sites.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('settings.employees.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('settings.features.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('settings.branding.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('settings.emails.templates.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('settings.documentation.index') }}" class="setting-card">
                    <div class="card-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
