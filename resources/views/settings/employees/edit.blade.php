        ...
        <div class="header-container">
            <div class="header-left">
                ...
                <div>
                    ...
                    <p class="employee-id">Employee ID: {{ $employee->employee_number }}</p>
                </div>
            </div>
        </div>
    </x-slot>
        ...
        <div class="content-wrapper">
            <div class="form-container">
                ...
                <div class="form-content">
                    <form method="POST" action="{{ route('settings.employees.update', $employee) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-grid two-column">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="leaver" {{ old('status', $employee->status) === 'leaver' ? 'selected' : '' }}>Leaver</option>
                                    </select>
                                    @error('status')
                                    <span class="form-error">{{ $message }}</span>
                                    @enderror
