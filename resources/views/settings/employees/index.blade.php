<x-app-layout>
    <x-slot name="header">
        ...
        <div class="header-container">
            ...
            <a href="{{ route('settings.employees.create') }}" class="create-employee-btn">
                Add New Employee
            </a>
        </div>
    </x-slot>
                    ...
                    <div class="filter-row">
                        ...
                        <div class="filter-group">
                            ...
                            <select name="status" id="status" class="status-select">
                                ...
                                <option value="leaver" {{ request('status') === 'leaver' ? 'selected' : '' }}>Leaver</option>
                            </select>
                        </div>
                    </div>

                    @if(request()->hasAny(['search', 'site_id', 'branch_id', 'status']))
                        <a href="{{ route('settings.employees.index') }}" class="clear-filters-btn">Clear Filters</a>
                    @endif
                </form>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    @if($employee->number)
                                        <div class="employee-number">{{ $employee->number }}</div>
                                    @endif
                                </div>
                            </td>
                            <td>{{ $employee->site->name ?? 'N/A' }}</td>
                            <td>{{ $employee->site->branch->branch_name ?? '-' }}</td> {{-- Display only branch name --}}
                            <td>
                            ...
                            <td>
                                <div class="action-links">
                                    <a href="{{ route('settings.employees.edit', $employee) }}" class="edit-link">
                                        Edit
                                    </a>
                                    <form method="POST" action="{{ route('settings.employees.destroy', $employee) }}"
