<x-app-layout>
    <x-slot name="header">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Create Feature</h2>
    </x-slot>
    ...
    <div class="py-10 px-4">
        <div class="form-container">
            <div class="form-title">
                <h3 style="font-size: 1.25rem; font-weight: 700; margin: 0;">Create New Feature</h3>
            </div>
            ...
            <form method="POST" action="{{ route('settings.features.store') }}">
                @csrf
                ...
                <div class="button-container">
                    <a href="{{ route('settings.features.index') }}" class="cancel-btn">
                        Cancel
                    </a>
