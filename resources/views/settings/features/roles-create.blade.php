<x-app-layout>
    <x-slot name="header">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Create Role</h2>
    </x-slot>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            .form-title { border-bottom-color: #374151; }
        }
        .helper-text {
            font-size: 0.75rem;
            color: #6b7280;
        ...
        @media (max-width: 640px) {
            ...
            .cancel-btn, .create-btn { width: 100%; text-align: center; }
        }
    </style>
    ...
    <div class="py-10 px-4">
        <div class="form-container">
            <div class="form-title">
                <h3 style="font-size: 1.25rem; font-weight: 700; margin: 0;">Create New Role</h3>
            </div>
