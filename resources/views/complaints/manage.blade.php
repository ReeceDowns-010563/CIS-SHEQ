            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="search-container">
                        <form method="GET" action="{{ route('complaints.manage') }}" class="search-input-group">
                            <input type="text"
                                   name="search"
                        ...
                        <div style="position: relative;">
                            ...
                            <div id="filterDropdown" class="filter-dropdown" style="display: none;">
                                <form method="GET" action="{{ route('complaints.manage') }}">
                                    ...
                                    <select name="show_archived">
                                        <option value="0" {{ request('show_archived') == '0' ? 'selected' : '' }}>Active Only</option>
                                        <option value="1" {{ request('show_archived') == '1' ? 'selected' : '' }}>Include Archived</option>
                                        <option value="archived_only" {{ request('show_archived') == 'archived_only' ? 'selected' : '' }}>Archived Only</option>
                                    </select>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                        ...
                                        @else
                                            <div class="user-select"
                                                 data-complaint-id="{{ $complaint->id }}"
                                                 data-current-assignment="{{ $complaint->assigned_to }}"
                                                 @if($complaint->archived) data-disabled="true" @endif>
                                                <div class="user-select-button">
                                                    ...
                                                    @endif
                                                    <span class="user-select-text">{{ $complaint->assignedTo->name ?? 'Unassigned' }}</span>
                                                    @if(!$complaint->archived)
                                                ...
                                                @if(!$complaint->archived)
                                                    <div class="user-select-dropdown">
                                                        ...
                                                        <div class="user-options">
                                                            ...
                                                            @foreach(\App\Models\User::orderBy('name')->get() as $user)
                                                                <div class="user-option" data-value="{{ $user->id }}">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if($complaint->archived)
                                                ...
                                                @endcan
                                            @else
                                                <form method="POST" action="{{ route('complaints.destroy', $complaint) }}" class="inline">
                                                    @csrf
                                                    @method('DELETE')
