<x-app-layout>
    ...
    <script>
        ...
        function previewReport() {
            ...
            window.open(`{{ route('reports.preview') }}?month=${month}&year=${year}`, '_blank');
        }
        ...
        function exportReport(format) {
            ...
            const urls = {
                pdf: `{{ route('reports.pdf') }}?month=${month}&year=${year}`,
                word: `{{ route('reports.word') }}?month=${month}&year=${year}`
            };
        ...
        function emailReport() {
            window.location.href = '{{ route("reports.email") }}';
        }
    </script>
</x-app-layout>
