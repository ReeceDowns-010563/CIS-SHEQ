...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="header-container">
            ...
            <a href="<?php echo e(route('settings.branches.create')); ?>" class="create-branch-btn">
                Add New Branch
            </a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="main-container">
        <div class="content-wrapper">
            ...
            <div class="filters-container">
                <form method="GET" class="filters-form">
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('settings.branches.index')); ?>" class="clear-filters-btn">Clear Filters</a>
                    <?php endif; ?>
                </form>
            </div>
                ...
                <table class="branches-table">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="font-medium"><?php echo e($branch->branch_name); ?></td>
                            <td><?php echo e($branch->created_at->format('M j, Y')); ?></td>
                            <td>
                                <div class="action-links">
                                    <a href="<?php echo e(route('settings.branches.edit', $branch)); ?>" class="edit-link">
                                        Edit
                                    </a>
                                    <form method="POST" action="<?php echo e(route('settings.branches.destroy', $branch)); ?>"
            ...
            <div class="pagination-container">
                <?php echo e($branches->appends(request()->query())->links()); ?>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/branches/index.blade.php ENDPATH**/ ?>