    ...
    <div class="selection-container">
        <div class="selection-wrapper">
            ...
            <div class="options-grid">
                <!-- Complaints Option -->
                <div class="option-card" onclick="window.location.href='<?php echo e(route('charts.complaints')); ?>'">
                    ...
                    <a href="<?php echo e(route('charts.complaints')); ?>" class="option-button">
                        View Complaints Charts →
                    </a>
                </div>

                <!-- Incidents Option -->
                <div class="option-card" onclick="window.location.href='<?php echo e(route('charts.incidents')); ?>'">
                    ...
                    <a href="<?php echo e(route('charts.incidents')); ?>" class="option-button incidents-button">
...
<?php endif; ?>
<?php /**PATH C:\Users\reece.downs\Downloads\fm-selection-j560679\public_html\laravel12\resources\views/charts/index.blade.php ENDPATH**/ ?>