...
<div class="metrics-grid">
    <?php $__currentLoopData = array_chunk($data['metrics'], 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metricChunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="metric-row">
            <?php $__currentLoopData = $metricChunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<!-- Trends Chart -->
<?php if(!empty($chartImages['trends'])): ?>
    <div class="chart-section">
        <h3 class="section-title">6-Month Complaint Trends</h3>
        <img src="data:image/png;base64,<?php echo e(base64_encode($chartImages['trends'])); ?>" alt="Trends Chart" class="chart-image">
    </div>
<?php endif; ?>
...
<table class="weekly-table">
    ...
    <?php $__currentLoopData = $data['weeklyData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="weekly-count"><?php echo e($week['count']); ?></td>
        </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
...
<!-- Pie Chart -->
<?php if(!empty($chartImages['pie'])): ?>
    <div class="chart-section">
        <h3 class="section-title">Top Complaint Categories</h3>
        <img src="data:image/png;base64,<?php echo e(base64_encode($chartImages['pie'])); ?>" alt="Complaint Categories Chart" class="chart-image" style="max-width: 400px;">
    </div>
<?php endif; ?>
...
<?php if($data['complaintTypes']->count() > 0): ?>
    ...
    <?php $__currentLoopData = $data['complaintTypes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="complaint-item">
            <span class="complaint-name"><?php echo e($type->nature); ?></span>
            <span class="complaint-count"><?php echo e($type->count); ?> (<?php echo e($percentage); ?>%)</span>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php else: ?>
...
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/reports/pdf-template.blade.php ENDPATH**/ ?>