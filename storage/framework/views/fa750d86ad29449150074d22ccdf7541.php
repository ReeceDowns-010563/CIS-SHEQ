...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex justify-center mb-6">
        <img src="<?php echo e(asset('images/logo-light.png')); ?>"
             alt="Company Logo"
             class="h-16 w-auto">
    </div>
    ...
    <div class="mb-6 text-sm text-gray-600 dark:text-gray-400 text-center">
        <?php echo e(__('No problem. Just enter your email address and we will send you a password reset link.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'email','class' => 'block mt-1 w-full focus:border-[#131F34] focus:ring-[#131F34]','type' => 'email','name' => 'email','value' => old('email'),'required' => true,'autofocus' => true,'placeholder' => 'your.email@example.com']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','class' => 'block mt-1 w-full focus:border-[#131F34] focus:ring-[#131F34]','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'placeholder' => 'your.email@example.com']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>