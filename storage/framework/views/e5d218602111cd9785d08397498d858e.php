...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.data-table','data' => ['id' => 'register','data' => $incidents,'columns' => $columns,'filters' => $filters,'searchFields' => ['brief_description', 'location'],'searchPlaceholder' => 'Search by description or location...','routeName' => 'incidents.register','showArchived' => true,'emptyMessage' => 'No incidents found']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'register','data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($incidents),'columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($columns),'filters' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filters),'search-fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['brief_description', 'location']),'search-placeholder' => 'Search by description or location...','route-name' => 'incidents.register','show-archived' => true,'empty-message' => 'No incidents found']); ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        function customRowClickHandler(incidentId) {
            ...
            const userRole = '<?php echo e(auth()->user()->role_name); ?>';
...
<?php endif; ?>
<?php /**PATH C:\Users\reece.downs\Downloads\fm-selection-j560679\public_html\laravel12\resources\views/incidents/register.blade.php ENDPATH**/ ?>