...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Manage Complaints</h2>
     <?php $__env->endSlot(); ?>
    ...
    <style>
        ...
        /* User dropdown with ROUNDED CORNERS - FIXED Z-INDEX */
        .user-select {
            position: relative;
            display: inline-block;
            min-width: 180px;
        ...
        .dark .user-search-input::placeholder {
            color: #6b7280;
        }
        ...
        .dark .user-option.selected .user-option-text {
            color: #bfdbfe;
        }
        ...
        @media (max-width: 768px) {
            ...
            .clean-select, .user-select {
                min-width: 100px;
            }

            .clean-select-button, .user-select-button {
                padding: 6px 8px;
                font-size: 12px;
                min-height: 32px;
            }
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="search-container">
                        <form method="GET" action="<?php echo e(route('complaints.manage')); ?>" class="search-input-group">
                            <input type="text"
                                   name="search"
                                   value="<?php echo e(request('search')); ?>"
                                   class="search-input"
                                   placeholder="Search by name, PCN, or site...">
                        ...
                        <div style="position: relative;">
                            ...
                            <div id="filterDropdown" class="filter-dropdown" style="display: none;">
                                <form method="GET" action="<?php echo e(route('complaints.manage')); ?>">
                                    ...
                                    <select name="show_archived">
                                        <option value="0" <?php echo e(request('show_archived') == '0' ? 'selected' : ''); ?>>Active Only</option>
                                        <option value="1" <?php echo e(request('show_archived') == '1' ? 'selected' : ''); ?>>Include Archived</option>
                                        <option value="archived_only" <?php echo e(request('show_archived') == 'archived_only' ? 'selected' : ''); ?>>Archived Only</option>
                                    </select>
                    ...
                    <div class="table-wrapper">
                        <table class="w-full bg-white dark:bg-gray-800" id="complaintsTable">
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Date Received</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Name</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">PCN Number</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Site</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Status</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Assigned To</th>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $complaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $complaint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="table-row-hover <?php echo e($complaint->archived ? 'archived-row' : ''); ?>">
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300">
                                        <?php echo e($complaint->pcn_number); ?>

                                    </td>
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300">
                                        <?php echo e($complaint->site->name ?? 'N/A'); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                        <?php if($complaint->archived): ?>
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800">
                                                    Archived
                                                </span>
                                        <?php else: ?>
                                            <div class="clean-select status-<?php echo e($complaint->status); ?>"
                                                 data-complaint-id="<?php echo e($complaint->id); ?>"
                                                 data-current-status="<?php echo e($complaint->status); ?>"
                                                 <?php if($complaint->archived): ?> data-disabled="true" <?php endif; ?>>
                                                <div class="clean-select-button">
                                                    <span class="status-text"><?php echo e(ucfirst($complaint->status)); ?></span>
                                                    <?php if(!$complaint->archived): ?>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                        <?php if($complaint->archived): ?>
                                            <span class="text-sm text-gray-500">
                                                    <?php echo e($complaint->assignedTo->name ?? 'Unassigned'); ?>

                                                </span>
                                        <?php else: ?>
                                            <div class="user-select"
                                                 data-complaint-id="<?php echo e($complaint->id); ?>"
                                                 data-current-assignment="<?php echo e($complaint->assigned_to); ?>"
                                                 <?php if($complaint->archived): ?> data-disabled="true" <?php endif; ?>>
                                                <div class="user-select-button">
                                                    <?php if($complaint->assignedTo): ?>
                                                        <div class="user-avatar">
                                                            <?php echo e(strtoupper(substr($complaint->assignedTo->name, 0, 1))); ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <span class="user-select-text"><?php echo e($complaint->assignedTo->name ?? 'Unassigned'); ?></span>
                                                    <?php if(!$complaint->archived): ?>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                        ...
                                        <div class="comments-container">
                                            <button
                                                type="button"
                                                class="comments-btn"
                                                onclick="openCommentsModal(<?php echo e($complaint->id); ?>)"
                                                data-complaint-id="<?php echo e($complaint->id); ?>"
                                            >
                                                ...
                                                <span class="comments-count" id="comments-count-<?php echo e($complaint->id); ?>" data-count="<?php echo e($complaint->comments_count ?? 0); ?>">
                                                        <?php if(($complaint->comments_count ?? 0) > 0): ?>
                                                        <?php echo e($complaint->comments_count); ?>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <?php if($complaint->archived): ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('unarchive', $complaint)): ?>
                                                    <form method="POST" action="<?php echo e(route('complaints.unarchive', $complaint)); ?>" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PATCH'); ?>
                                                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-xs transition-colors duration-200" onclick="return confirm('Are you sure you want to restore this complaint?')">
                                                            Restore
                                                        </button>
                                                    </form>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <form method="POST" action="<?php echo e(route('complaints.destroy', $complaint)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-xs transition-colors duration-200" onclick="return confirm('Are you sure you want to archive this complaint?')">
                                                        Archive
                                                    </button>
                                                </form>
                                            <?php endif; ?>
                                ...
                                <tr>
                                    <td colspan="9" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center space-y-2">
                                            ...
                                            <p class="text-sm">No complaints match the current filters.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
    ...
    <script>
        ...
        // Status and Assignment change handlers - NOW USING PHP FORMS
            ...
            document.querySelectorAll('.user-select').forEach(select => {
                ...
                dropdown.querySelectorAll('.user-option').forEach(option => {
                    option.addEventListener('click', function() {
                        const newAssignment = this.dataset.value;
                        const complaintId = select.dataset.complaintId;
                        const currentAssignment = select.dataset.currentAssignment;
                        ...
                        const form = document.createElement('form');
                        form.method = 'POST';
                        form.action = `/complaints/${complaintId}/assignment`;
                        ...
                        assignmentInput.name = 'assigned_to';
                        assignmentInput.value = newAssignment;
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/complaints/manage.blade.php ENDPATH**/ ?>