                    ...
                    <div class="section-container">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php if(!empty($incident->incident_type_other_description) && $incident->incident_type_other_description !== null): ?>
                                        Other
                                    <?php else: ?>
                            ...
                            <?php if(!empty($incident->incident_type_other_description) && $incident->incident_type_other_description !== null): ?>
                                <div class="form-group">
                                    ...
                                    <div class="form-display" style="padding: 12px; border: 1px solid var(--border); border-radius: 6px; background: var(--bg-alt);">
                                        <?php echo e($incident->incident_type_other_description); ?>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="form-display form-display-textarea"><?php echo e(trim($incident->what_happened)); ?></div>
                            </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="form-display form-display-textarea"><?php echo e($incident->additional_information ? trim($incident->additional_information) : 'None provided'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-container">
                        ...
                        <?php if($incident->affected_person_source === 'Employee'): ?>
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php echo e($incident->affectedEmployee ? $incident->affectedEmployee->first_name . ' ' . $incident->affectedEmployee->last_name : 'N/A'); ?>
                        ...
                        <?php elseif($incident->affected_person_source === 'Customer'): ?>
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php echo e($incident->affectedCustomer ? $incident->affectedCustomer->name : 'N/A'); ?>
                    ...
                    <div class="section-container">
                        ...
                        <div class="form-grid">
                                ...
                                <div class="form-display">
                                    ...
                                    <?php if(!empty($displayItems)): ?>
                                        <div class="body-parts-tags">
                                            <?php $__currentLoopData = $displayItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bodyPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="body-part-tag"><?php echo e($bodyPart); ?></span>
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="form-display form-display-textarea"><?php echo e($incident->physician_details ? trim($incident->physician_details) : 'None provided'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-container">
                        ...
                        <?php if($incident->reported_by_source === 'Employee'): ?>
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php echo e($incident->reportedEmployee ? $incident->reportedEmployee->first_name . ' ' . $incident->reportedEmployee->last_name : 'N/A'); ?>
                        ...
                        <?php elseif($incident->reported_by_source === 'Customer'): ?>
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php echo e($incident->reportedCustomer ? $incident->reportedCustomer->name : 'N/A'); ?>
                    ...
                    <div class="section-container">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="form-display">
                                    <?php echo e($incident->coordinator->name ?? 'Not assigned'); ?>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/incidents/show.blade.php ENDPATH**/ ?>