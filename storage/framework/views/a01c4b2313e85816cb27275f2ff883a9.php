    ...
    <div class="page-container">
        <div class="form-container">
            <div class="card">
                ...
                <div class="progress-header">
                    <div class="progress-content">
                        ...
                        <div class="progress-date">
                            Created <?php echo e($incident->created_at->format('M j, Y')); ?>
                ...
                <form action="<?php echo e(route('incidents.update', $incident)); ?>" method="POST" enctype="multipart/form-data" class="form">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('brief_description', $incident->brief_description)); ?>"
                                    class="form-input"
                                    required
                                    maxlength="255"
                            ...
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="incident_type_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $incidentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($type->id); ?>">
                                    ...
                                    <select id="incident_type_id" name="incident_type_id" class="hidden-select" required>
                                        ...
                                        <?php $__currentLoopData = $incidentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>" <?php echo e(old('incident_type_id', $incident->incident_type_id) == $type->id ? 'selected' : ''); ?>>
                                                <?php echo e($type->name); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <option value="other" <?php echo e(old('incident_type_id', $incident->incident_type_id) === 'other' ? 'selected' : ''); ?>>
                                            Other (please specify)
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group full-width" id="incident_type_other_wrapper" style="display: none;">
                                ...
                                ><?php echo e(old('incident_type_other_description', $incident->incident_type_other_description)); ?></textarea>
                                <div class="form-help">
                            ...
                            <div class="form-group full-width">
                                ...
                                <input
                                    ...
                                    id="location"
                                    name="location"
                                    value="<?php echo e(old('location', $incident->location)); ?>"
                                    class="form-input"
                                    required
                            ...
                            <div class="form-group full-width">
                                ...
                                ><?php echo e(old('what_happened', $incident->what_happened)); ?></textarea>
                                <div class="form-help">
                            ...
                            <div class="form-group full-width">
                                ...
                                ><?php echo e(old('additional_information', $incident->additional_information)); ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('date_of_occurrence', $incident->date_of_occurrence?->format('Y-m-d'))); ?>"
                                    class="form-input"
                                    required
                                />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('time_of_occurrence', $incident->time_of_occurrence ? \Carbon\Carbon::parse($incident->time_of_occurrence)->format('H:i') : '')); ?>"
                                    class="form-input"
                                    required
                                />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="branch_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($branch->id); ?>">
                                    ...
                                    <select id="branch_id" name="branch_id" class="hidden-select" required>
                                        ...
                                        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($branch->id); ?>" <?php echo e(old('branch_id', $incident->branch_id) == $branch->id ? 'selected' : ''); ?>>
                                                <?php echo e($branch->display_name ?? $branch->branch_name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="site_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($site->id); ?>" data-branch-id="<?php echo e($site->branch_id); ?>">
                                    ...
                                    <select id="site_id" name="site_id" class="hidden-select">
                                        ...
                                        <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($site->id); ?>" data-branch-id="<?php echo e($site->branch_id); ?>" <?php echo e(old('site_id', $incident->site_id) == $site->id ? 'selected' : ''); ?>>
                                                <?php echo e($site->name); ?>
                    ...
                    <div class="section-container">
                        ...
                        <div class="form-group">
                            ...
                            <select id="affected_person_source" name="affected_person_source" class="form-input" required>
                                <option value="Employee" <?php echo e(old('affected_person_source', $incident->affected_person_source) == 'Employee' ? 'selected' : ''); ?>>Employee</option>
                                <option value="Customer" <?php echo e(old('affected_person_source', $incident->affected_person_source) == 'Customer' ? 'selected' : ''); ?>>Customer</option>
                                <option value="Other" <?php echo e(old('affected_person_source', $incident->affected_person_source) == 'Other' ? 'selected' : ''); ?>>Other</option>
                            </select>
                        </div>

                        <div id="affected_employee_wrapper" style="<?php echo e(old('affected_person_source', $incident->affected_person_source) === 'Employee' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="affected_employee_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($employee->id); ?>" data-site-id="<?php echo e($employee->site_id); ?>">
                                                    <?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?>

                                                    <span class="employee-site-badge"><?php echo e($employee->site->name ?? ''); ?></span>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                    <select id="affected_employee_id" name="affected_employee_id" class="hidden-select">
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($employee->id); ?>" data-site-id="<?php echo e($employee->site_id); ?>" <?php echo e(old('affected_employee_id', $incident->affected_employee_id) == $employee->id ? 'selected' : ''); ?>>
                                                <?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?>
                        ...
                        <div id="affected_customer_wrapper" style="<?php echo e(old('affected_person_source', $incident->affected_person_source) === 'Customer' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="affected_customer_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($customer->id); ?>">
                                    ...
                                    <select id="affected_customer_id" name="affected_customer_id" class="hidden-select">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer->id); ?>" <?php echo e(old('affected_customer_id', $incident->affected_customer_id) == $customer->id ? 'selected' : ''); ?>>
                                                <?php echo e($customer->name); ?>
                        ...
                        <div id="affected_person_other_wrapper" style="<?php echo e(old('affected_person_source', $incident->affected_person_source) === 'Other' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('affected_person_other', $incident->affected_person_other)); ?>"
                                    class="form-input"
                    ...
                    <div class="section-container">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="treatment_type_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $treatmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($treatment->id); ?>">
                                    ...
                                    <select id="treatment_type_id" name="treatment_type_id" class="hidden-select" required>
                                        ...
                                        <?php $__currentLoopData = $treatmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($treatment->id); ?>" <?php echo e(old('treatment_type_id', $incident->treatment_type_id) == $treatment->id ? 'selected' : ''); ?>>
                                                <?php echo e($treatment->name); ?>
                                        ...
                                        <div class="multi-select-options">
                                            <?php $__currentLoopData = $bodyParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bodyPart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="multi-select-option">
                                                    <input type="checkbox" name="body_part_id[]" value="<?php echo e($bodyPart->id); ?>"
                                                        <?php echo e((is_array(old('body_part_id', $incident->body_part_id ?? [])) && in_array($bodyPart->id, old('body_part_id', $incident->body_part_id ?? []))) ? 'checked' : ''); ?>>
                                                    <span class="checkmark"></span>
                                                    <span class="option-text"><?php echo e($bodyPart->name); ?></span>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <label class="multi-select-option">
                                                <input type="checkbox" name="body_part_id[]" value="other"
                                                    <?php echo e((!empty($incident->body_part_other) || (is_array(old('body_part_id', [])) && in_array('other', old('body_part_id', [])))) ? 'checked' : ''); ?>>
                                                <span class="checkmark"></span>
                            ...
                            <div class="form-group" id="body_part_other_container" style="<?php echo e((!empty($incident->body_part_other) || (is_array(old('body_part_id', [])) && in_array('other', old('body_part_id', [])))) ? '' : 'display: none;'); ?>">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('body_part_other', $incident->body_part_other)); ?>"
                                    class="form-input"
                            ...
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="injury_type_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $injuryTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $injuryType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($injuryType->id); ?>">
                                    ...
                                    <select id="injury_type_id" name="injury_type_id" class="hidden-select">
                                        ...
                                        <?php $__currentLoopData = $injuryTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $injuryType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($injuryType->id); ?>" <?php echo e(old('injury_type_id', $incident->injury_type_id) == $injuryType->id ? 'selected' : ''); ?>>
                                                <?php echo e($injuryType->name); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <option value="other" <?php echo e((old('injury_type_id') == 'other' || (!$incident->injury_type_id && $incident->injury_type_other)) ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group" id="injury_type_other_container" style="<?php echo e((old('injury_type_id') == 'other' || (!$incident->injury_type_id && $incident->injury_type_other)) ? '' : 'display: none;'); ?>">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('injury_type_other', $incident->injury_type_other)); ?>"
                                    class="form-input"
                            ...
                            <div class="form-group full-width">
                                ...
                                ><?php echo e(old('physician_details', $incident->physician_details)); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-container">
                        ...
                        <div class="form-group">
                            ...
                            <select id="reported_by_source" name="reported_by_source" class="form-input" required>
                                <option value="Employee" <?php echo e(old('reported_by_source', $incident->reported_by_source) == 'Employee' ? 'selected' : ''); ?>>Employee</option>
                                <option value="Customer" <?php echo e(old('reported_by_source', $incident->reported_by_source) == 'Customer' ? 'selected' : ''); ?>>Customer</option>
                                <option value="Other" <?php echo e(old('reported_by_source', $incident->reported_by_source) == 'Other' ? 'selected' : ''); ?>>Other</option>
                            </select>
                        </div>

                        <div id="reported_employee_wrapper" style="<?php echo e(old('reported_by_source', $incident->reported_by_source) === 'Employee' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="reported_employee_id">
                                    ...
                                    <select id="reported_employee_id" name="reported_employee_id" class="hidden-select">
                                        <option value="">Choose employee...</option>
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($employee->id); ?>" data-site-id="<?php echo e($employee->site_id); ?>" <?php echo e(old('reported_employee_id', $incident->reported_employee_id) == $employee->id ? 'selected' : ''); ?>>
                                                <?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?>
                        ...
                        <div id="reported_customer_wrapper" style="<?php echo e(old('reported_by_source', $incident->reported_by_source) === 'Customer' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="reported_customer_id">
                                    ...
                                    <select id="reported_customer_id" name="reported_customer_id" class="hidden-select">
                                        <option value="">Choose customer...</option>
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer->id); ?>" <?php echo e(old('reported_customer_id', $incident->reported_customer_id) == $customer->id ? 'selected' : ''); ?>>
                                                <?php echo e($customer->name); ?>
                        ...
                        <div id="reported_by_other_wrapper" style="<?php echo e(old('reported_by_source', $incident->reported_by_source) === 'Other' ? '' : 'display: none;'); ?>">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('reported_by_other', $incident->reported_by_other)); ?>"
                                    class="form-input"
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="coordinator_id">
                                    ...
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            ...
                                            <?php $__currentLoopData = $sheqUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($user->id); ?>">
                                    ...
                                    <select id="coordinator_id" name="coordinator_id" class="hidden-select">
                                        ...
                                        <?php $__currentLoopData = $sheqUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>" <?php echo e(old('coordinator_id', $incident->coordinator_id) == $user->id ? 'selected' : ''); ?>>
                                                <?php echo e($user->name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="searchable-select" data-select="status">
                                    <div class="select-display" tabindex="0">
                                        <span class="select-value"><?php echo e(ucfirst($incident->status)); ?></span>
                                        <svg class="select-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                        </svg>
                                    </div>
                                    <div class="select-dropdown">
                                        ...
                                        <div class="select-options">
                                            <?php $__currentLoopData = ['pending', 'investigating', 'completed', 'closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="select-option" data-value="<?php echo e($status); ?>">
                                    ...
                                    <select id="status" name="status" class="hidden-select">
                                        <?php $__currentLoopData = ['pending', 'investigating', 'completed', 'closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($status); ?>" <?php echo e(old('status', $incident->status) == $status ? 'selected' : ''); ?>>
                                                <?php echo e(ucfirst($status)); ?>
                                    ...
                                    <?php $__currentLoopData = $incident->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="attachment-item">
                                            ...
                                            <div class="attachment-actions">
                                                ...
                                                <form method="POST" action="<?php echo e(route('incidents.remove-attachment', [$incident, $index])); ?>" style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="action-buttons">
                        <div class="button-group">
                            <a href="<?php echo e(route('incidents.register')); ?>" class="cancel-btn">
                                <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?><?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/incidents/edit.blade.php ENDPATH**/ ?>