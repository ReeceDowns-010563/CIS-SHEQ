...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-10 px-4">
        <div class="form-container">
            ...
            <div class="info-box">
                <strong>Editing:</strong> <?php echo e($branch->display_name); ?> (Created <?php echo e($branch->created_at->format('M j, Y')); ?>)
                <?php if($branch->sites()->count() > 0): ?>
                    <br><strong>Sites:</strong> This branch is assigned to <?php echo e($branch->sites()->count()); ?> site(s)
                <?php endif; ?>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('settings.branches.update', $branch)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="button-container">
                    <a href="<?php echo e(route('settings.branches.index')); ?>" class="cancel-btn">
                        Cancel
                    </a>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/branches/edit.blade.php ENDPATH**/ ?>