    ...
    <div class="py-12 px-4">
        <div class="download-container">
            ...
            <div class="download-content">
                <form action="<?php echo e(route('complaints.export')); ?>" method="POST" id="exportForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="export-options">
                        ...
                        <!-- PDF Report -->
                        <label class="export-option" for="pdf" onclick="window.location.href='<?php echo e(route('reports.export')); ?>'">
                    ...
                    <div class="filter-row" style="display: flex; gap:1rem; flex-wrap: wrap; margin-bottom:1.5rem;">
                        <div class="filter-item">
                            ...
                            <input type="date" name="date_received_from" id="date_received_from" value="<?php echo e(old('date_received_from')); ?>" class="mt-1 block w-full rounded border-gray-300" />
                            <?php $__errorArgs = ['date_received_from'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="filter-item">
                            ...
                            <input type="date" name="date_received_to" id="date_received_to" value="<?php echo e(old('date_received_to')); ?>" class="mt-1 block w-full rounded border-gray-300" />
                            <?php $__errorArgs = ['date_received_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="multi-select-options" id="siteOptions">
                                ...
                                <div class="options-container" id="optionsContainer">
                                    ...
                                    <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="multi-select-option" data-value="<?php echo e($site->id); ?>" data-name="<?php echo e($site->name); ?>">
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/complaints/download.blade.php ENDPATH**/ ?>