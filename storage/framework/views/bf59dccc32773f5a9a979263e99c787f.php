...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-300">Create User</h2>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-10 px-4">
        <div class="form-container">
            <div class="form-title">
                <h3 style="font-size: 1.25rem; font-weight: 700; margin: 0;">Create New User</h3>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('settings.users.store')); ?>" id="userForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select
                            ...
                            class="form-select"
                        >
                            <option value="" disabled <?php echo e(old('role_id') ? '' : 'selected'); ?>>Select role</option>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role->id); ?>"
                                    <?php echo e((string) old('role_id') === (string) $role->id ? 'selected' : ''); ?>>
                ...
                <div class="button-container">
                    <a href="<?php echo e(route('settings.users.index')); ?>" class="cancel-btn">
                        Cancel
                    </a>
    ...
    <script>
        class UserAccessManager {
            constructor() {
                this.branches = <?php echo json_encode($branchesData, 15, 512) ?>;
                this.sites = <?php echo json_encode($sitesData, 15, 512) ?>;
            ...
            renderDropdownItems(type, searchTerm = '') {
                ...
                const filteredItems = items.filter(item =>
                    ...
                    (type === 'sites' && item.branch_name.toLowerCase().includes(searchTerm.toLowerCase()))
                );

                // Limit to 15 visible items
            ...
            createDropdownItem(type, data) {
                ...
                const isSelected = type === 'branches'
                    ? this.selectedBranches.has(data.id)
                    : this.selectedSites.has(data.id);
            ...
            handleItemToggle(type, id, isSelected) {
                if (type === 'branches') {
                    ...
                    if (isSelected) {
                        ...
                        // Auto-add the corresponding branch
                        ...
                        // Check if we should remove the branch
                        const site = this.sites.find(s => s.id === id);
                        if (site) {
            ...
            removeBranch(branchId) {
                ...
                // Remove all sites from this branch
        ...
        // Initialize the access manager when the page loads
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/users/create.blade.php ENDPATH**/ ?>