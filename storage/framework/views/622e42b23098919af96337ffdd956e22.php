     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="header-container">
            <div class="header-left">
                <a href="<?php echo e(route('settings.features.index')); ?>" class="back-button" title="Back to Feature Access Control">
            ...
            <a href="<?php echo e(route('settings.roles.create')); ?>" class="create-feature-btn">
                Create New Role
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-links">
                                    <a href="<?php echo e(route('settings.roles.edit', $role)); ?>" class="edit-link">Edit</a>
                                    <form method="POST" action="<?php echo e(route('settings.roles.destroy', $role)); ?>" style="display:inline;" onsubmit="return confirm('Delete this role?');">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            <td colspan="5" class="empty-message">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('settings.roles.create')); ?>" class="create-role-btn">
                                        Add Role
                                    </a>
                                </div>
                            </td>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/features/roles-index.blade.php ENDPATH**/ ?>