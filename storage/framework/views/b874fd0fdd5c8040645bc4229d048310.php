    ...
    <div class="main-container">
        <div class="content-wrapper">
            <div class="form-container">
                ...
                <form method="POST" action="<?php echo e(route('settings.sites.store')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="branchDropdown">
                                        ...
                                        <input type="hidden" name="branch_id" id="branchIdInput" value="<?php echo e(old('branch_id')); ?>">
                                    </div>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/sites/create.blade.php ENDPATH**/ ?>