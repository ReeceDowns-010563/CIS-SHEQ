...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="header-container">
            <div class="header-left">
                <a href="<?php echo e(route('settings.emails.templates.index')); ?>" class="back-button" title="Back to Templates">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </a>
                <h2 class="header-title"><?php echo e($emailTemplate->name); ?></h2>
            </div>
            <div class="header-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sendTest', $emailTemplate)): ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="status-badge status-<?php echo e($emailTemplate->is_active ? 'active' : 'inactive'); ?>">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value"><?php echo e($emailTemplate->key); ?></div>
                    </div>

                    <?php if($emailTemplate->category): ?>
                        <div class="detail-item">
                            <div class="detail-label">Category</div>
                            <div class="detail-value"><?php echo e(ucfirst($emailTemplate->category)); ?></div>
                        </div>
                    <?php endif; ?>

                    <div class="detail-item">
                        <div class="detail-label">Created</div>
                        <div class="detail-value"><?php echo e($emailTemplate->created_at?->format('M j, Y') ?? 'Unknown'); ?></div>
                    </div>

                    <div class="detail-item">
                        <div class="detail-label">Last Updated</div>
                        <div class="detail-value"><?php echo e($emailTemplate->updated_at?->format('M j, Y') ?? 'Unknown'); ?></div>
                    </div>
                </div>
                ...
                <?php if($emailTemplate->description): ?>
                    <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb;">
                        ...
                        <div class="detail-value" style="margin-top: 0.5rem;"><?php echo e($emailTemplate->description); ?></div>
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <div class="variables-list">
                        <?php $__currentLoopData = $variables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="variable-item">
                                <div class="variable-name"><?php echo e($variable); ?></div>
                                <div class="variable-sample">
                                    <?php echo e($emailTemplate->getSampleDataForVariable($variable) ?: 'Dynamic content'); ?>
    ...
    <script>
        let currentTemplateId = <?php echo e($emailTemplate->id); ?>;
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/emails/templates/show.blade.php ENDPATH**/ ?>