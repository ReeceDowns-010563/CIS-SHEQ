...
<div id="<?php echo e($modalId); ?>" class="corrective-actions-modal">
    <div class="corrective-actions-modal-content">
        <div class="corrective-actions-modal-header">
            <h3 class="corrective-actions-modal-title"><?php echo e($title); ?></h3>
        ...
        <div class="corrective-actions-modal-body">
            <div class="corrective-actions-notice">
                ...
                <div class="notice-content">
                    ...
                    <p>Before closing or completing this <?php echo e($itemType); ?>, you must provide corrective actions taken to prevent similar occurrences in the future.</p>
                </div>
            </div>
...
<script>
    ...
    let currentItemType = '<?php echo e($itemType); ?>';
    ...
    function openCorrectiveActionsModal(itemId, newStatus) {
        ...
        document.getElementById('<?php echo e($modalId); ?>').style.display = 'block';
    ...
    function closeCorrectiveActionsModal() {
        document.getElementById('<?php echo e($modalId); ?>').style.display = 'none';
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' && document.getElementById('<?php echo e($modalId); ?>').style.display === 'block') {
            closeCorrectiveActionsModal();
        }
    });
...
<?php /**PATH C:\Users\reece.downs\Downloads\fm-selection-j560679\public_html\laravel12\resources\views/incidents/components/corrective-actions-modal.blade.php ENDPATH**/ ?>