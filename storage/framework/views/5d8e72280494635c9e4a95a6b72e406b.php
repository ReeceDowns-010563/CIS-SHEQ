...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-10 px-4">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('settings.users.update', $user)); ?>" id="userForm">
                <?php echo csrf_field(); ?>
                        ...
                        >
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role->id); ?>"
                                    <?php echo e((string) old('role_id', $user->role_id) === (string) $role->id ? 'selected' : ''); ?>>
    ...
    <script>
        class UserAccessManager {
            ...
            loadCurrentSelections() {
                ...
                <?php if($user->accessSettings): ?>
                    this.allBranches = <?php echo e($user->accessSettings->all_branches ? 'true' : 'false'); ?>;
                this.allSites = <?php echo e($user->accessSettings->all_sites ? 'true' : 'false'); ?>;
                <?php endif; ?>

                // Load selected branches
                <?php if($user->accessibleBranches->count() > 0): ?>
                    <?php $__currentLoopData = $user->accessibleBranches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    this.selectedBranches.add(<?php echo e($branch->id); ?>);
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>

                // Load selected sites
                <?php if($user->accessibleSites->count() > 0): ?>
                    <?php $__currentLoopData = $user->accessibleSites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    this.selectedSites.add(<?php echo e($site->id); ?>);
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            }
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/users/edit.blade.php ENDPATH**/ ?>