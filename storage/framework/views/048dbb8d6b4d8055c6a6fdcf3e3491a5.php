...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="header-container">
            <div class="header-left">
                <a href="<?php echo e(route('settings.index')); ?>" class="back-button" title="Back to Settings" aria-label="Back to Settings">
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('settings.features.create')); ?>" class="btn btn-primary">
                    New Feature
                </a>
                <a href="<?php echo e(route('settings.roles.index')); ?>" class="btn btn-primary">
                    Manage Roles
                </a>
            </div>
        </div>
    ...
    <div class="main-container">
        <div class="content-wrapper">
            ...
            <div class="table-container">
                <table class="features-table">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <span class="feature-key"><?php echo e($feature->key); ?></span>
                            </td>
                            <td style="font-weight: 600;"><?php echo e($feature->name); ?></td>
                            <td><?php echo e($feature->description ?? '—'); ?></td>
                            <td>
                                <?php if($feature->roles->isEmpty()): ?>
                                    <span style="color: #6b7280; font-style: italic;">None</span>
                                <?php else: ?>
                                    <div class="roles-container">
                                        <?php $__currentLoopData = $feature->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="role-badge role-<?php echo e(strtolower($role->name)); ?>" data-role-name="<?php echo e(strtolower($role->name)); ?>">
                                                <?php echo e(ucfirst($role->display_name ?? $role->name)); ?>
                            ...
                            <td>
                                <?php echo e($feature->updated_at?->diffForHumans() ?? $feature->created_at?->diffForHumans() ?? '—'); ?>

                            </td>
                            <td>
                                <div class="action-links">
                                    <a href="<?php echo e(route('settings.features.edit', $feature)); ?>" class="edit-link">Edit</a>
                                    <form method="POST" action="<?php echo e(route('settings.features.destroy', $feature)); ?>" style="display: inline;" onsubmit="return confirm('Delete this feature?');">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            <td colspan="6" class="empty-message">
                                <div style="text-align: center;">
                                    ...
                                    <a href="<?php echo e(route('settings.features.create')); ?>" class="create-feature-btn">
                                        Add Feature
                                    </a>
                                </div>
                            </td>
            ...
            <?php if(isset($features) && $features->hasPages()): ?>
                <div class="pagination-container">
                    <?php echo e($features->withQueryString()->links()); ?>
...
<?php endif; ?>
<?php /**PATH /home/sites/29a/4/4aab0e4a5e/public_html/laravel12/resources/views/settings/features/index.blade.php ENDPATH**/ ?>